...
void KF_Init(KF_TypeDef *kf) {
	...
	KF_SetQ(kf, 0.001f, 0.001f, 0.001f, 0.001f);
...
void KF_Predict(KF_TypeDef *kf, float voltage) {
	...
	kf->x[0] = kf->F[0][0] * x0 + kf->F[0][1] * x1 + kf->F[0][2] * x2
			+ kf->F[0][3] * x3 + kf->B[0] * voltage;

	kf->x[1] = kf->F[1][0] * x0 + kf->F[1][1] * x1 + kf->F[1][2] * x2
			+ kf->F[1][3] * x3 + kf->B[1] * voltage;

	kf->x[2] = kf->F[2][0] * x0 + kf->F[2][1] * x1 + kf->F[2][2] * x2
			+ kf->F[2][3] * x3 + kf->B[2] * voltage;

	kf->x[3] = kf->F[3][0] * x0 + kf->F[3][1] * x1 + kf->F[3][2] * x2
			+ kf->F[3][3] * x3 + kf->B[3] * voltage;
	...
	float FP00 = kf->F[0][0] * P00 + kf->F[0][1] * P10 + kf->F[0][2] * P20
			+ kf->F[0][3] * P30;
	float FP01 = kf->F[0][0] * P01 + kf->F[0][1] * P11 + kf->F[0][2] * P21
			+ kf->F[0][3] * P31;
	float FP02 = kf->F[0][0] * P02 + kf->F[0][1] * P12 + kf->F[0][2] * P22
			+ kf->F[0][3] * P32;
	float FP03 = kf->F[0][0] * P03 + kf->F[0][1] * P13 + kf->F[0][2] * P23
			+ kf->F[0][3] * P33;

	float FP10 = kf->F[1][0] * P00 + kf->F[1][1] * P10 + kf->F[1][2] * P20
			+ kf->F[1][3] * P30;
	float FP11 = kf->F[1][0] * P01 + kf->F[1][1] * P11 + kf->F[1][2] * P21
			+ kf->F[1][3] * P31;
	float FP12 = kf->F[1][0] * P02 + kf->F[1][1] * P12 + kf->F[1][2] * P22
			+ kf->F[1][3] * P32;
	float FP13 = kf->F[1][0] * P03 + kf->F[1][1] * P13 + kf->F[1][2] * P23
			+ kf->F[1][3] * P33;

	float FP20 = kf->F[2][0] * P00 + kf->F[2][1] * P10 + kf->F[2][2] * P20
			+ kf->F[2][3] * P30;
	float FP21 = kf->F[2][0] * P01 + kf->F[2][1] * P11 + kf->F[2][2] * P21
			+ kf->F[2][3] * P31;
	float FP22 = kf->F[2][0] * P02 + kf->F[2][1] * P12 + kf->F[2][2] * P22
			+ kf->F[2][3] * P32;
	float FP23 = kf->F[2][0] * P03 + kf->F[2][1] * P13 + kf->F[2][2] * P23
			+ kf->F[2][3] * P33;

	float FP30 = kf->F[3][0] * P00 + kf->F[3][1] * P10 + kf->F[3][2] * P20
			+ kf->F[3][3] * P30;
	float FP31 = kf->F[3][0] * P01 + kf->F[3][1] * P11 + kf->F[3][2] * P21
			+ kf->F[3][3] * P31;
	float FP32 = kf->F[3][0] * P02 + kf->F[3][1] * P12 + kf->F[3][2] * P22
			+ kf->F[3][3] * P32;
	float FP33 = kf->F[3][0] * P03 + kf->F[3][1] * P13 + kf->F[3][2] * P23
			+ kf->F[3][3] * P33;
