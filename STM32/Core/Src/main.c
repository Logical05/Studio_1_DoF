...
//     AICAN_Master_RxCallback(hfdcan); /* ← only this line needed */
// }
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin) { Safety_EXTI_Callback(GPIO_Pin); }
